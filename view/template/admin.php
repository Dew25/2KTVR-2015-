<?php ob_start();?>
<?php $script="<script src='/2KTVR-2015-/view/js/admin.js'></script>"; ?>
	<h2>Администрирование странички</h2>
<form action="/2KTVR-2015-/index.php/add" method="POST" name="add_form" id='form1'
	<table>
		<tr>
			<td>Автор: </td>
		...
		<tr>
			...
			<td><input type="button" name="change" onclick="update($_REQUEST['id']);" value="Изменить"></td>
		</tr>
	</table>
</form>
<h3>Список постов</h3>
